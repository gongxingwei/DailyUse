<template>
    <v-avatar :size="size" :color="avatarColor" :class="avatarClass" @click="handleClick"
        ...
        <!-- 状态指示器 -->
        <v-badge v-if="showStatus" :color="statusColor" :content="statusContent" :dot="statusDot"
            :offset-x="statusOffsetX" :offset-y="statusOffsetY" location="bottom end" />
