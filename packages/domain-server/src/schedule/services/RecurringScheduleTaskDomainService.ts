...
export class RecurringScheduleTaskDomainService {
  constructor(
    private readonly repository: IRecurringScheduleTaskRepository,
   ...
   * 获取任务详情
   */
  async getTask(uuid: string): Promise<RecurringScheduleTask | null> {
   ...
   * 获取所有任务
   */
  async getAllTasks(): Promise<RecurringScheduleTask[]> {
