...
export class Setting extends AggregateRoot implements ISettingServer {
  ...
  public toPersistenceDTO(): SettingPersistenceDTO {
    return {
      ...
      is_system_setting: this._isSystemSetting,
      sync_config: this._syncConfig ? JSON.stringify(this._syncConfig.toServerDTO()) : null,
  ...
  public static fromPersistenceDTO(dto: SettingPersistenceDTO): Setting {
    ...
    return new Setting({
      ...
      isSystemSetting: dto.is_system_setting,
      syncConfig: dto.sync_config ? SyncConfig.fromServerDTO(JSON.parse(dto.sync_config)) : null,
