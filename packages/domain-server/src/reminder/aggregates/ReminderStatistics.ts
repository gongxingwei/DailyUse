...
export class ReminderStatistics extends AggregateRoot implements IReminderStatisticsServer {
  ...
  public get templateStats(): TemplateStatsInfo { return { ...this._templateStats }; }
  public get groupStats(): GroupStatsInfo { return { ...this._groupStats }; }
  public get triggerStats(): TriggerStatsInfo { return { ...this._triggerStats }; }
  public get calculatedAt(): number { return this._calculatedAt; }
  ...
  public static create(params: { accountUuid: string }): ReminderStatistics {
    ...
    return new ReminderStatistics({
      uuid, accountUuid: params.accountUuid,
      templateStats: { totalTemplates: 0, activeTemplates: 0, pausedTemplates: 0, oneTimeTemplates: 0, recurringTemplates: 0 },
      groupStats: { totalGroups: 0, activeGroups: 0, pausedGroups: 0, groupControlledGroups: 0, individualControlledGroups: 0 },
      triggerStats: { todayTriggers: 0, weekTriggers: 0, monthTriggers: 0, totalTriggers: 0, successfulTriggers: 0, failedTriggers: 0 },
      calculatedAt: now
    });
  }
  ...
  public static fromServerDTO(dto: ReminderStatisticsServerDTO): ReminderStatistics {
    return new ReminderStatistics({
      uuid: dto.uuid, accountUuid: dto.accountUuid,
      templateStats: dto.templateStats, groupStats: dto.groupStats,
      triggerStats: dto.triggerStats, calculatedAt: dto.calculatedAt
    });
  }

  public static fromPersistenceDTO(dto: ReminderStatisticsPersistenceDTO): ReminderStatistics {
    return new ReminderStatistics({
      uuid: dto.uuid, accountUuid: dto.account_uuid,
  ...
  public async calculate(): Promise<void> {
    ...
    this.addDomainEvent({
      eventType: 'ReminderStatisticsUpdated', aggregateId: this.uuid,
      occurredOn: new Date(), accountUuid: this._accountUuid,
  ...
  public sync(data: { templateStats: TemplateStatsInfo; groupStats: GroupStatsInfo; triggerStats: TriggerStatsInfo }): void {
  ...
  public toPersistenceDTO(): ReminderStatisticsPersistenceDTO {
    return {
      uuid: this.uuid, account_uuid: this.accountUuid,
