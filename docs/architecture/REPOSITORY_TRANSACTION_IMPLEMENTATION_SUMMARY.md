...
export interface IAuthCredentialRepository {
  ...
  findByAccountUuid(accountUuid: string, tx?: PrismaTransactionClient): Promise<AuthCredential | null>;
  findAll(params?: { skip?: number; take?: number }, tx?: PrismaTransactionClient): Promise<AuthCredential[]>;
...
export interface IAuthSessionRepository {
  ...
  findByRefreshToken(refreshToken: string, tx?: PrismaTransactionClient): Promise<AuthSession | null>;
