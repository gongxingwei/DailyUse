...
export interface AccountServer {
  ...
  updateNotificationSettings(notifications: Partial<AccountServer['preferences']['notifications']>): void;
...
export interface AccountService {
  ...
  updateSubscription(accountUuid: string, subscription: Partial<SubscriptionServer>): Promise<SubscriptionServer>;
