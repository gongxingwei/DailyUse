...
export interface ReminderTemplateControlService {
  ...
  batchCalculateEffectiveEnabled(
    templates: ReminderTemplateServer[],
...
export interface ReminderService {
  ...
  updateTemplate(
    uuid: string,
    updates: Partial<ReminderTemplateServer>,
  ): Promise<ReminderTemplateServer>;
