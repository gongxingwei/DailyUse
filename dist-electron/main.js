...
const MAIN_DIST$1 = process.env.MAIN_DIST ?? sysPath__default.join(process.env.APP_ROOT ?? process.cwd(), "dist-electron");
class QuickLauncherMainPlugin {
  ...
  createQuickLauncherWindow() {
    ...
    const preloadPath = sysPath__default.resolve(MAIN_DIST$1, "quickLauncher_preload.mjs");
    ...
    if (process.env.VITE_DEV_SERVER_URL) {
      ...
      this.quickLauncherWindow.loadFile(
        sysPath__default.join(process.env.APP_ROOT || "", "dist/src/plugins/quickLauncher/index.html")
      );
    }
