...
// 初始化依赖
const authCredentialRepository = new PrismaAuthCredentialRepository();
const sessionRepository = new PrismaSessionRepository();
const tokenRepository = new PrismaTokenRepository();
const mfaDeviceRepository = new PrismaMFADeviceRepository();

const authenticationService = new AuthenticationApplicationService(
