 ...
 *         description: 模板激活成功
 */
router.post('/:templateId/activate', TaskTemplateController.activateTemplate);
 ...
 *         description: 模板暂停成功
 */
router.post('/:templateId/pause', TaskTemplateController.pauseTemplate);
 ...
 *         description: 模板归档成功
 */
router.post('/:templateId/archive', TaskTemplateController.archiveTemplate);
...
/**
 * @swagger
 * /tasks/templates/instances/{instanceId}/reminders/{reminderId}/trigger:
 *   post:
 *     tags: [Task Instances]
 *     summary: 触发提醒
 *     security:
...
/**
 * @swagger
 * /tasks/templates/instances/{instanceId}/reminders/{reminderId}/snooze:
 *   post:
 *     tags: [Task Instances]
 *     summary: 延后提醒
 *     security:
...
/**
 * @swagger
 * /tasks/templates/instances/{instanceId}/reminders/{reminderId}/dismiss:
 *   post:
 *     tags: [Task Instances]
 *     summary: 忽略提醒
 *     security:
