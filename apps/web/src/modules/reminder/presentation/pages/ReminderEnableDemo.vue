        ...
        <div class="demo-sections">
            ...
            <section class="demo-section">
                ...
                <div class="control-grid">
                    ...
                    <div class="control-actions">
                        <button @click="toggleGroupEnableMode" :disabled="!groupUuid">
                            切换启用模式
                        </button>
                        <button @click="toggleGroupEnabled" :disabled="!groupUuid">
                            切换启用状态
                        </button>
                    </div>
                </div>
            ...
            <section class="demo-section">
                ...
                <div class="control-grid">
                    <div class="control-item">
                        ...
                        <textarea v-model="batchTemplateUuids" placeholder="uuid1,uuid2,uuid3" rows="3"></textarea>
                    </div>
                    <div class="control-actions">
            ...
            <section class="demo-section">
                ...
                <div class="control-grid">
                    ...
                    <div class="control-actions">
                        <button @click="getUpcomingReminders">
                            获取即将到来的提醒
                        </button>
                    </div>
                </div>
                ...
                <div v-if="upcomingData" class="upcoming-results">
                    ...
                    <div v-if="upcomingData.reminders?.length" class="instances-list">
                        <div v-for="reminder in upcomingData.reminders.slice(0, 5)" :key="reminder.uuid"
                            class="instance-card">
