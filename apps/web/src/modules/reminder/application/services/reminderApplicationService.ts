...
export class ReminderDomainApplicationService {
   ...
   * ```
   */
  async createReminderTemplate(template: ReminderTemplate): Promise<ApiResponse<{ template: ReminderTemplate }>> {
    try {
      // 发送 IPC 请求到主进程
   ...
   * ```
   */
  async updateReminderTemplate(template: ReminderTemplate): Promise<ApiResponse<{ template: ReminderTemplate }>> {
    try {
   ...
   * ```
   */
  async createReminderGroup(group: ReminderTemplateGroup): Promise<ApiResponse<{ group: ReminderTemplateGroup }>> {
    try {
   ...
   * ```
   */
  async updateReminderGroup(group: ReminderTemplateGroup): Promise<ApiResponse<{ group: ReminderTemplateGroup }>> {
    try {
   ...
   */
  async setGroupEnableMode(groupId: string, mode: "group" | "individual"): Promise<ApiResponse<void>> {
    try {
