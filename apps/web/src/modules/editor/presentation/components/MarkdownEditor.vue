    ...
    <div class="markdown-editor">
        ...
        <div class="editor-toolbar">
            ...
            <template v-if="mode === 'edit' && editor">
                ...
                <v-btn size="small" icon="mdi-format-bold" :class="{ 'is-active': editor.isActive('bold') }"
                    @click="editor.chain().focus().toggleBold().run()" />
                <v-btn size="small" icon="mdi-format-italic" :class="{ 'is-active': editor.isActive('italic') }"
                    @click="editor.chain().focus().toggleItalic().run()" />
                <v-btn size="small" icon="mdi-format-strikethrough" :class="{ 'is-active': editor.isActive('strike') }"
                    @click="editor.chain().focus().toggleStrike().run()" />

                <v-divider vertical class="mx-2" />

                <v-btn size="small" icon="mdi-format-header-1"
                    :class="{ 'is-active': editor.isActive('heading', { level: 1 }) }"
                    @click="editor.chain().focus().toggleHeading({ level: 1 }).run()" />
                <v-btn size="small" icon="mdi-format-header-2"
                    :class="{ 'is-active': editor.isActive('heading', { level: 2 }) }"
                    @click="editor.chain().focus().toggleHeading({ level: 2 }).run()" />
                <v-btn size="small" icon="mdi-format-header-3"
                ...
                <v-btn size="small" icon="mdi-format-list-numbered"
                    :class="{ 'is-active': editor.isActive('orderedList') }"
                    @click="editor.chain().focus().toggleOrderedList().run()" />
                <v-btn size="small" icon="mdi-code-tags" :class="{ 'is-active': editor.isActive('codeBlock') }"
        ...
        <div class="editor-content">
            ...
            <!-- 预览模式 -->
            <div v-show="mode === 'preview'" class="editor-preview-mode markdown-body" v-html="renderedHtml" />
        </div>
    </div>
</template>
