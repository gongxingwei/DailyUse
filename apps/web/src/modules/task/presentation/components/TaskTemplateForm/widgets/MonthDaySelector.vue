...
<template>
    <div class="month-day-selector">
        ...
        <v-chip-group v-model="localSelected" multiple variant="outlined" selected-class="text-primary"
            class="flex-wrap">
            <v-chip v-for="day in monthDayOptions" :key="day" :value="day" filter variant="outlined" size="small">
                {{ day }}
            </v-chip>
        </v-chip-group>

        <div class="mt-2">
            <v-btn size="small" variant="text" @click="selectFirstHalf">
                前半月
            </v-btn>

            <v-btn size="small" variant="text" @click="selectSecondHalf">
                后半月
            </v-btn>

            <v-btn size="small" variant="text" @click="selectOddDays">
                奇数日
            </v-btn>

            <v-btn size="small" variant="text" @click="selectEvenDays">
                偶数日
            </v-btn>
            ...
            <v-btn size="small" variant="text" @click="clearAll">
                清空
            </v-btn>
        </div>
    </div>
