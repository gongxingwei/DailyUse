<template>
    <div class="repository-page">
        <!-- 仓库管理 Dialog -->
        <RepositoryManagementDialog v-model="managementDialogOpen" @repository-selected="handleRepositorySelected" />
        ...
        <div class="repo-container">
            ...
            <div class="repo-sidebar">
                ...
                <div class="sidebar-search">
                    <v-text-field v-model="sidebarSearch" density="compact" placeholder="搜索文件..."
                ...
                <div class="sidebar-content">
                    <v-list density="compact">
                        <v-list-item v-for="folder in folders" :key="folder.id" :prepend-icon="folder.icon"
                            :title="folder.name" @click="selectFolder(folder.id)" />
                    </v-list>
                    ...
                    <v-list density="compact">
                        <v-list-item v-for="resource in filteredResources" :key="resource.uuid" :title="resource.name"
                            :subtitle="resource.path" @click="selectResource(resource.uuid)">
                            <template #prepend>
                ...
                <div class="sidebar-footer">
                    <v-divider />
                    <v-list-item :title="currentRepositoryName" :subtitle="currentRepositoryPath" density="compact"
            ...
            <div class="repo-main">
                <!-- 顶部工具栏 -->
                <RepoHeader v-model="currentView" @search="handleSearch" @refresh="handleRefresh" @sync="handleSync"
                    ...
                    <div v-else class="manage-view">
                        <div class="manage-header">
                            ...
                            <div class="manage-actions">
                                ...
                                <v-btn prepend-icon="mdi-upload" size="small" variant="outlined" @click="handleImport">
                                    导入
                                </v-btn>
                            </div>
                        </div>
                        ...
                        <div class="resource-grid">
                            <v-card v-for="resource in filteredResources" :key="resource.uuid" class="resource-card"
                                    ...
                                    <div class="d-flex align-center justify-space-between mb-2">
                                        ...
                                        <v-menu>
                                            <template #activator="{ props }">
                                                <v-btn icon="mdi-dots-vertical" variant="text" size="x-small"
                                                    v-bind="props" />
                                            </template>
                                            <v-list density="compact">
