...
import { ref } from 'vue';
import LocalQuickLogin from '@renderer/modules/Authentication/presentation/components/LocalQuickLogin.vue';
import LocalLogin from '@renderer/modules/Authentication/presentation/components/LocalLoginForm.vue';
import LocalRegister from '@renderer/modules/Account/presentation/components/LocalRegisterForm.vue';
import AnimatedTrain from '@renderer/shared/animation/AnimatedTrain.vue';
