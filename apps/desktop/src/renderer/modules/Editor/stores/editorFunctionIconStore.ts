...
export const useEditorFunctionIconStore = defineStore('editorFunctionIcon', {
    ...
    editorFunctionIcons: [
      {
        ...
        icon: 'mdi-eye',
        action: function () {
          useEditorFunctionIconStore().handlePreview();
        },
      },
      {
        uuid: 'split-editor',
        ...
        action: function () {
          useEditorFunctionIconStore().handleSplitEditor();
        },
      },
    ...
    moreFunctions: [
      {
        ...
        action: function () {
          useEditorFunctionIconStore().closeAllEditors();
        },
      },
    ] as MoreFunction[],
    showMenu: false,
  ...
  actions: {
    handlePreview() {
      ...
      const currentGroup = editorGroupStore.editorGroups.find(
        (g) => g.uuid === editorGroupStore.activeGroupId,
      );
