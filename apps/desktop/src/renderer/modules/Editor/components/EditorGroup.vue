...
const group = computed(() => editorGroupStore.editorGroups.find((g) => g.uuid === props.groupId));
...
const activeTab = computed(() => editorTabs.value.find((t) => t.uuid === activeTabId.value));
