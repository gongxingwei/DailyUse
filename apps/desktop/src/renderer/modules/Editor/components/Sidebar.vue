<template>
  <div
    class="sidebar custom-border"
    v-show="store.isSidebarVisible"
    :style="{
  ...
  >
    <component
      :is="store.activeActivityBarItem.component"
      v-if="store.activeActivityBarItem"
      :root-path="repositoryStore.currentRepositoryPath()"
    />
  </div>
</template>
