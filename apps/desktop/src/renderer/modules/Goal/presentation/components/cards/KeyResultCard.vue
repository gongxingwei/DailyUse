...
import GoalRecordDialog from '@renderer/modules/Goal/presentation/components/dialogs/GoalRecordDialog.vue';
import { useGoalRecordDialog } from '@renderer/modules/Goal/presentation/composables/useGoalRecordDialog';
