<template>
  <v-container fluid class="goal-info-container pa-0">
    ...
    />
    <GoalReviewCard
      :visible="goalReviewDialog.show"
      :goal="goalReviewDialog.goal as Goal"
...
import { Repository } from '@renderer/modules/Repository';
// 组件
import GoalDialog from '@renderer/modules/Goal/presentation/components/dialogs/GoalDialog.vue';
import GoalReviewCard from '@renderer/modules/Goal/presentation/components/cards/GoalReviewCard.vue';
import ConfirmDialog from '@renderer/shared/components/ConfirmDialog.vue';
import KeyResultCard from '@renderer/modules/Goal/presentation/components/cards/KeyResultCard.vue';
import RepoInfoCard from '@renderer/modules/Repository/presentation/components/RepoInfoCard.vue';
// utils
