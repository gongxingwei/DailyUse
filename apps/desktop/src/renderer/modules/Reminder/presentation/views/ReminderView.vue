<template>
  <div class="reminder-view">
    ...
    <reminder-template-group-card
      ...
      :template-group-uuid="reminderTemplateGroupCard.templateGroupUuid as string"
    ...
    <!-- GroupDialog -->
    <group-dialog
      :model-value="groupDialog.show"
      :group="groupDialog.group as ReminderTemplateGroup"
      @update:modelValue="groupDialog.show = $event"
      @create-group="handleCreateReminderGroup"
      @update-group="handleUpdateReminderGroup"
    />

    <!-- TemplateMoveDialog -->
    <template-move-dialog
      :model-value="moveTemplateDialog.show"
      :template="moveTemplateDialog.template as ReminderTemplate"
      @update:modelValue="moveTemplateDialog.show = $event"
      @move="handleMoveTemplateToGroup"
    />
...
// components
import ReminderGrid from '@renderer/modules/Reminder/presentation/components/grid/ReminderGrid.vue';
import ReminderTemplateCard from '@renderer/modules/Reminder/presentation/components/ReminderTemplateCard.vue';
import ReminderTemplateGroupCard from '@renderer/modules/Reminder/presentation/components/ReminderTemplateGroupCard.vue';
import TemplateDialog from '@renderer/modules/Reminder/presentation/components/dialogs/TemplateDialog.vue';
import GroupDialog from '@renderer/modules/Reminder/presentation/components/dialogs/GroupDialog.vue';
import ConfirmDialog from '@renderer/shared/components/ConfirmDialog.vue';
import TemplateMoveDialog from '@renderer/modules/Reminder/presentation/components/dialogs/TemplateMoveDialog.vue';
// composables
import { useReminderServices } from '@renderer/modules/Reminder/presentation/composables/useReminderServices';
...
provide(
  ...
  (groupUuid: string, enableMode: ReminderTemplateGroup['enableMode']) => {
...
const { allGridItems, selectItem, closeDetailPanel } = useReminderGrid();
