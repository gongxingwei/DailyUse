...
export class TaskDomainApplicationService {
   ...
   * 更新任务模板
   */
  async updateTaskTemplate(dto: ITaskTemplateDTO): Promise<ApiResponse<TaskTemplate>> {
    try {
   ...
   * 创建任务实例
   */
  async createTaskInstance(dto: ITaskInstanceDTO): Promise<ApiResponse<TaskInstance>> {
    try {
