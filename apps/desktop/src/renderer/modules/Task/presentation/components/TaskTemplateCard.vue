    ...
    <v-card-title class="template-header">
      <div class="header-content">
        ...
        <div class="header-meta">
          ...
          <v-chip
            :color="getImportanceColor(template.metadata.importance)"
            variant="outlined"
            size="small"
          ...
          <v-chip
            :color="getUrgencyColor(template.metadata.urgency)"
            variant="outlined"
            size="small"
    ...
    <v-card-text class="template-content">
      ...
      <div class="template-meta">
        ...
        <div class="meta-item">
          ...
          <span class="meta-text">
            ...
            <span v-if="template.metadata.tags.length > 0" class="tags">
              ...
              <span v-if="template.metadata.tags.length > 2"
                >等{{ template.metadata.tags.length }}个标签</span
              >
            </span>
          </span>
        </div>
        ...
        <div v-if="template.keyResultLinks?.length" class="meta-item">
          ...
          <span class="meta-text"> 关联 {{ template.keyResultLinks.length }} 个关键结果 </span>
        </div>
      </div>
        ...
        <div class="analytics-row">
          ...
          <div class="analytics-item">
            ...
            <span class="analytics-value"
              >{{ Math.round(template.analytics.successRate * 100) }}%</span
            >
          </div>
          <div v-if="template.analytics.averageCompletionTime" class="analytics-item">
            <span class="analytics-label">平均用时：</span>
            <span class="analytics-value">{{
              formatCompletionTime(template.analytics.averageCompletionTime)
            }}</span>
          </div>
        </div>
      </div>
