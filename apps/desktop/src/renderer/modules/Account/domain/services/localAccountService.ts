...
class LocalAccountService {
   ...
   * @returns 注册成功的用户信息
   */
  async register(form: AccountRegistrationRequest): Promise<ApiResponse> {
    try {
  ...
  //  * @returns {Promise<ApiResponse>} 返回一个包含以下结构的 Promise
  //  */
  ...
  //  * @returns {Promise<ApiResponse>} 返回一个包含以下结构的 Promise
  //  */
  // async deregistration(username: string): Promise<ApiResponse> {
  //   try {
  ...
  //  * @returns {Promise<ApiResponse>} 返回一个包含以下结构的 Promise
  //  */
  // async logoutWithToken(token: string): Promise<ApiResponse> {
  //   try {
  ...
  //  * @returns {Promise<ApiResponse>} 返回一个包含以下结构的 Promise
  //  */
  // async changePassword(accountUuid: string, oldPassword: string, newPassword: string): Promise<ApiResponse> {
  //   try {
