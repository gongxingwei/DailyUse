import { scheduleIpcClient } from '../ipcs/scheduleIpcClient';
...
export class ScheduleService {
    ...
    async createSchedule(options: ScheduleOptions): Promise<boolean> {
        return await scheduleIpcClient.createSchedule(options);
    }
    ...
    async updateSchedule(options: ScheduleOptions): Promise<boolean> {
        return await scheduleIpcClient.updateSchedule(options);
    }
    ...
    async getSchedules(): Promise<string[]> {
        return await scheduleIpcClient.getSchedules();
    }
