    ...
    <div class="layout-container">
      ...
      <div class="content-container">
        ...
        <v-navigation-drawer location="left" class="navigation-drawer" v-model="isDrawerExpanded" temporary>
          <v-list>
            <v-list-item prepend-icon="mdi-credit-card-outline" :title="t('mainLayout.navigation.summary')"
              :to="'/summary'"></v-list-item>
            <v-list-item prepend-icon="mdi-fencing" :title="t('mainLayout.navigation.goal')"
              :to="'/goal-management'"></v-list-item>
            <v-list-item prepend-icon="mdi-list-box" :title="t('mainLayout.navigation.task')"
              :to="'/task-management'"></v-list-item>
            <v-list-item prepend-icon="mdi-database" :title="t('mainLayout.navigation.repository')"
              :to="'/repository'"></v-list-item>
            <v-list-item prepend-icon="mdi-bell" :title="t('mainLayout.navigation.reminder')"
              :to="'/reminder'"></v-list-item>
            <v-list-item prepend-icon="mdi-bell" :title="t('mainLayout.navigation.test')" :to="'/test'"></v-list-item>
          </v-list>
          ...
          <v-list>
            <v-list-item v-for="repo in repositoryStore.repositories" :key="repo.title" :title="repo.title"
              :to="`/repository/${repo.title}`"></v-list-item>
          </v-list>

          <template v-slot:append>
            <v-divider></v-divider>
            <v-list>
              <v-list-item prepend-icon="mdi-account" :title="t('mainLayout.navigation.profile')"
                :to="'/profile'"></v-list-item>
              <v-list-item prepend-icon="mdi-cog" :title="t('mainLayout.navigation.settings')"
                :to="'/setting'"></v-list-item>
            </v-list>
          </template>
        </v-navigation-drawer>
