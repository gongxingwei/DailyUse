...
import { useTimeConfigValidation } from '@/modules/Task/composables/useTimeConfigValidation';
interface Props {
...
const updateStartDate = (date: string) => {
  ...
  localData.value = {
    ...
    timeConfig: {
      ...
      baseTime: {
        ...localData.value.timeConfig.baseTime,
        start: newStart
      }
    }
  };
...
const updateEndDate = (date: string) => {
  ...
  const newEnd = TimeUtils.updateDate(currentEnd, date);
...
const updateEndTime = (time: string) => {
  ...
  const newEnd = TimeUtils.updateTime(currentEnd, time);
