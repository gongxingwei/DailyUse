<template>
    <v-card
      ...
      :class="{ 'key-result-card--completed': progress >= 100 }"
      variant="outlined"
      elevation="0"
      :hover="true"
        ...
        <div class="d-flex align-center justify-space-between w-100">
          <div class="key-result-title">
            ...
            <div class="d-flex align-center mt-1">
              <v-icon 
                :color="progress >= 100 ? 'success' : 'medium-emphasis'" 
                size="16" 
                class="mr-1"
              >
    ...
    <RecordDialog 
      ...
      @save="(record) => handleSaveRecord(record, props.goalId, props.keyResult.id)" 
