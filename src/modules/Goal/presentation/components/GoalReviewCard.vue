<template>
  <v-dialog v-model="$props.visible" max-width="900" max-height="90vh" persistent scrollable class="goal-review-dialog">
    <v-card class="review-card">
      ...
      <v-card-text class="review-content pa-6">
        ...
        <div v-else class="review-list">
          <v-card v-for="review in goal.reviews" :key="review.uuid" class="review-item mb-4" variant="outlined"
