...
vi.mock('@common/shared/domain/aggregateRoot', () => ({
  AggregateRoot: class MockAggregateRoot {
    protected _uuid: string;

    constructor(uuid: string) {
      this._uuid = uuid || this.generateId();
    }
    ...
    generateId(): string {
      return MockAggregateRoot.generateId();
    }
  },
}));

vi.mock('@common/shared/domain/entity', () => ({
