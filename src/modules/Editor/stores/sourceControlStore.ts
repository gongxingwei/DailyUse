...
import { GitStatus, GitResponse, GitLogResponse } from '@/shared/types/git'
...
declare global {
  interface Window {
    git: {
      initialize: (workingDirectory: string) => Promise<GitResponse>
      getStatus: () => Promise<GitResponse>
      ...
      onStatusChanged: (callback: (status: GitResponse) => void) => void
      stageAll: () => Promise<void>
      unstageAll: () => Promise<void>
      discardAll: () => Promise<void>
      getCommitHistory: () => Promise<GitResponse>
