...
export class Repository extends AggregateRoot implements IRepository {
  ...
  constructor(props: RepositoryProps) {
    super(props.uuid || Repository.generateId());
  ...
  clone(): Repository {
    ...
    cloneRepo._createdAt = new Date(this._createdAt.getTime()); // 深
    cloneRepo._updatedAt = new Date(this._updatedAt.getTime()); // 深拷贝时间戳
    return cloneRepo;
  }
  ...
  static fromDTO(dto: IRepository): Repository {
    ...
    repo._createdAt = new Date(dto.createdAt);
    repo._updatedAt = new Date(dto.updatedAt);
    return repo;
  }
